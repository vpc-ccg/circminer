...
UniqSeg::UniqSeg(const UniqSeg &other) : start(other.start), end(other.end), next_exon_beg(other.next_exon_beg),
...
inline bool
MatchedRead::go_for_update(const MatchedMate &r1, const MatchedMate &r2, int32_t tlen, bool gm_compatible, int type) {
...
MatePair::MatePair(const MatePair &other) : type(other.type), score(other.score), forward(other.forward),
